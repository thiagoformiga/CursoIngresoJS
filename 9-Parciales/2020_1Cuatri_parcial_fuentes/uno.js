...
function mostrar()
{
	...
	while(respuesta=="si")
	{
		bodegaIngresada=prompt("¿en cual bodega desea ingresarolo?(Avellaneda,CABA, Lanus)");
		while(bodegaIngresada!= "Avellandeda" && bodegaIngresada!= "CABA" && bodegaIngresada!= "Lanus")
		{
		bodegaIngresada=prompt("error, ingresa una  bodega valida (Avellaneda,CABA, Lanus)");
		}
		productoIngresado=prompt("ingresa un producto");
	}
}*/